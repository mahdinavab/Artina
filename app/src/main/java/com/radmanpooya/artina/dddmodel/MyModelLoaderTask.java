package com.radmanpooya.artina.dddmodel;
 ...
 *
 */
public class MyModelLoaderTask extends LoaderTask {
     ...
     */
    public MyModelLoaderTask(Activity parent, URI uri, LoadListener callback) {
            ...
            try {
                ...
                Object3DData obj51 = new WavefrontLoader(GLES20.GL_TRIANGLE_FAN, new LoadListenerAdapter(){
                    ...
                    public void onLoad(Object3DData obj53) {
                        ...
                        MyModelLoaderTask.this.onLoad(obj53);
                    }
